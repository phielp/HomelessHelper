...
public interface RequestRepository extends CrudRepository<Request, Long> {
	...
	@Query("SELECT u.userName, r.description, r.requestTitle, r.id, r.photo, u.latitude, u.longitude, u.id, r.requestSupplier from User u, Request r where r.createdBy = u.id" )
